...
(
    id_gender_user serial primary key,
...
create table sex_animals
(
    id_sex_animal serial primary key,
...
insert into users (username, firstname, description, email, city, password, departement, id_gender_user) values ('Garry', 'Garry', 'test', 'test@test.com', 'Paris', 'test1', '75', '4');
